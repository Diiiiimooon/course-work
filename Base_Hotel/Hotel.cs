...
namespace Base_Hotel
{
    public partial class Hotel : Form
    {
        ...
        static internal NpgsqlConnection npgsql = new NpgsqlConnection("Server=localhost;Port=5432;User ID=postgres;Password=1234;Database=hotel_base"); // Соединение с БД
