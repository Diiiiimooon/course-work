...
namespace Base_Hotel
{
    public partial class Numbers : Form
    {
        public Numbers()
        {
            ...
            if (Hotel.currentUser.AcNumbers == "0") // Установка в соответствии с правами пользователя
            {
                add.Enabled = false;
                edit.Enabled = false;
                delete.Enabled = false;
            }
            if (Hotel.currentUser.AcNumbers == "1")
            {
                add.Enabled = false;
                edit.Enabled = true;
                delete.Enabled = false;
            }
            if (Hotel.currentUser.AcNumbers == "2")
            {
                add.Enabled = true;
                edit.Enabled = true;
                delete.Enabled = false;
            }
            if (Hotel.currentUser.AcNumbers == "3")
            {
                add.Enabled = true;
                edit.Enabled = true;
                delete.Enabled = true;
