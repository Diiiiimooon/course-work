...
namespace Base_Hotel
{
    public partial class Payment : Form
    {
        public Payment()
        {
            ...
            if (Hotel.currentUser.AcPayment == "0") // Установка в соответствии с правами пользователя
            {
                add.Enabled = false;
                edit.Enabled = false;
                delete.Enabled = false;
            }
            if (Hotel.currentUser.AcPayment == "1")
            {
                add.Enabled = false;
                edit.Enabled = true;
                delete.Enabled = false;
            }
            if (Hotel.currentUser.AcPayment == "2")
            {
                add.Enabled = true;
                edit.Enabled = true;
                delete.Enabled = false;
            }
            if (Hotel.currentUser.AcPayment == "3")
            {
                add.Enabled = true;
                edit.Enabled = true;
                delete.Enabled = true;
